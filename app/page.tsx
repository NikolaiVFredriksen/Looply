...
export default function Home() {
  ...
  const handleEdit = (updated: Loop) => {
    const updatedLoops = loops.map((l) => (l.id === updated.id ? updated : l));
    save(updatedLoops);
    setEditingLoop(null);
  };
        ...
        <AnimatePresence>
          ...
          >
            ...
            >
              ...
              <input
                type="text"
                value={editingLoop.title}
                onChange={(e) =>
                  setEditingLoop({ ...editingLoop, title: e.target.value })
                }
                style={{
                  width: "100%",
                  background: "rgba(255,255,255,0.8)",
              ...
              <textarea
                placeholder="why is it hard to close? (optional)"
                value={editingLoop.why}
                onChange={(e) =>
                  setEditingLoop({ ...editingLoop, why: e.target.value })
                }
                style={{
                  width: "100%",
                  background: "rgba(255,255,255,0.8)",
              ...
              <div style={{ display: "flex", gap: 10, marginTop: 4 }}>
                ...
                <button
                  onClick={() => handleEdit(editingLoop)}
                  style={{
                    flex: 2,
                    padding: "13px 0",
                    borderRadius: 14,
